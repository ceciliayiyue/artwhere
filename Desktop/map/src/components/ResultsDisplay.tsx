        ...
        >
          ...
          >
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold">Where Created?</span>
                  </div>
                ...
                {!result.createdCorrect && result.createdDistance && (
                  <p className="text-sm mt-1 ml-7 opacity-90">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold">Where Now?</span>
                  </div>
                  <div className="text-lg font-bold">
            ...
            <motion.button
              ...
              onClick={handleNext}
              className="w-full mt-6 px-6 py-3 bg-white text-gray-800 rounded-xl font-bold hover:scale-105 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group"
            >
            ...
            <motion.p
              ...
              className="text-center mt-3 text-xs opacity-75"
            >
