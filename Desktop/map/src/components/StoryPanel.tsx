              ...
              {!result?.createdCorrect && painting?.createdLocation.name && (
                <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                  <p className="text-base text-blue-800 font-semibold">
                    <strong className="text-lg">Created in:</strong> {painting.createdLocation.name}
                  </p>
                </div>
              )}
              ...
              {!result?.currentCorrect && painting?.currentLocation.name && (
                <div className="mt-3 p-4 bg-red-50 border-l-4 border-red-500 rounded">
                  <p className="text-base text-red-800 font-semibold">
                    <strong className="text-lg">Currently located in:</strong> {painting.currentLocation.name}
                  </p>
                </div>
              )}
            </div>
